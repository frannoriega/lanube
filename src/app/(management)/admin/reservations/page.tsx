...
function ReservationsPageContent() {
  ...
  const [service, setService] = useState<AdminResourceServiceSlug>(() =>
    paramService && isAdminResourceServiceSlug(paramService)
      ? paramService
      : defaultAdminResourceServiceSlug(),
  );

  useEffect(() => {
    if (paramService && isAdminResourceServiceSlug(paramService)) {
