                    ...
                    <CardContent className="w-full flex flex-col gap-6 items-center">
                        ...
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-full">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input type="password" {...field} className="bg-slate-200 aria-invalid:border-red-600" />
                                            </FormControl>
                                ...
                                <Button type="submit" className="w-full bg-slate-200 hover:bg-slate-300 text-black font-semibold py-6 text-lg" size="lg" disabled={form.formState.isSubmitting || !form.formState.isValid}>
                                    {form.formState.isSubmitting ? "Reestableciendo..." : "Reestablecer contraseña"}
                                </Button>
                            </form>
                        </Form>
                    </CardContent>
