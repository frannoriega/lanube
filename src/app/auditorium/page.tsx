...
export default function AuditoriumPage() {
  ...
  const fetchReservations = async () => {
    try {
      const response = await fetch('/api/reservations?service=AUDITORIUM')
      if (response.ok) {
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Reserva el auditorio para eventos y presentaciones
          </p>
        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2 md:col-span-2">
                      ...
                      <Textarea
                        ...
                        placeholder="Describe el evento o presentación que realizarás..."
                        rows={3}
                        required
                      />
                    </div>
                ...
                {reservations.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Aún no tienes reservas de auditorio.
                    </p>
                  </div>
                ) : (
