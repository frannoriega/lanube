    ...
    >
      <g id="Capa_1-2" data-name="Capa 1">
        <g id="ISOLOGO">
          ...
          <path
            className="cls-2"
            d="M134.09,84.65c12.54-25.43,8.53-53.17-7.89-67.4-14.31-12.41-33.01-10.15-34.14-9.99"
          />
          <path
            className="cls-1"
          ...
          <path
            className="cls-5"
            d="M59.97,45.82c-57.6-.02-52.52,43.89-52.44,44.34,0,0,0,0,0,0,0,0,1.77,19.05,15.26,25.19,10.87,8.95,49.7,10.28,75.64-8.56"
          />
          <path
            className="cls-4"
          ...
          <g id="NODOS">
            <path
              className="cls-3"
              d="M51.65,77.53c1.39,13.23,4.95,31.63,14.46,50.18,2.57,5.02,5.28,9.45,7.96,13.35"
            />
            <path
              className="cls-3"
              d="M76.29,139.76c-1.37-19.94.12-41.44,6.69-63.25.46-1.53.94-3.04,1.44-4.53"
            />
            <path
              className="cls-3"
              d="M80.19,58.82c-2.44-2.99-7.1-7.82-13.82-9.74-2.45-.7-4.69-.88-6.58-.82"
            />
            <path
              className="cls-3"
              d="M111.55,134.59c-5.88,3.63-12.67,6.98-20.42,9.52-1.11.36-2.2.7-3.29,1.01"
            />
            <g>
              <circle
                className="cls-9"
                ...
                cy="106.4"
                r="14.71"
                transform="translate(-65.36 34.81) rotate(-40.33)"
              />
              <circle
                className="cls-8"
                cx="14.62"
                cy="106.26"
                r="12.43"
                transform="translate(-65.29 34.71) rotate(-40.33)"
              />
            </g>
            ...
            <circle
              ...
              cy="88.24"
              r="11.91"
              transform="translate(-25.83 106.13) rotate(-40.33)"
            />
            <circle
              className="cls-9"
              cx="134"
              cy="27.01"
              r="13.35"
              transform="translate(20.15 102.66) rotate(-45)"
            />
            <g>
              <circle
                className="cls-9"
                ...
                cy="74.25"
                r="11.91"
                transform="translate(-6.16 131.72) rotate(-40.33)"
              />
              <circle className="cls-6" cx="176.27" cy="74.25" r="9.53" />
            </g>
            <path
              className="cls-3"
              d="M167.62,78.23c-3.08,1.58-8.68,4.25-16.31,6.79-3.97,1.32-7.43,2.25-10.09,2.89"
            />
            <path
              className="cls-3"
              d="M92.06,60.28c15.45-.85,39.22-.72,63.52,5.83,4.65,1.25,8.88,2.63,12.71,4.04"
            />
            <path
              className="cls-3"
              d="M89.44,56.64c6.06-8.17,17.31-20.32,34.25-24.13,1.82-.41,3.62-.7,5.37-.89"
            />
            <path
              className="cls-3"
              d="M120.93,123.07c2.71-8.31,5.41-16.63,8.12-24.94"
            />
            <path
              className="cls-3"
              d="M24.14,98.27c4.98-3.79,10.75-9.09,15.64-16.2,1.63-2.38,2.98-4.68,4.1-6.87"
            />
            <path
              className="cls-3"
              d="M103.76,106.03c5.92-2.4,12.8-6.16,19.23-12.2,1.14-1.07,2.2-2.15,3.18-3.23"
            />
            ...
            <circle
              ...
              cy="68.53"
              r="9.7"
              transform="translate(-31.47 45) rotate(-37.75)"
            />
        ...
        <g id="LA_NUBE_POLO_TECNOLOGICO" data-name="LA NUBE POLO TECNOLOGICO">
          <g>
            <path
              className="cls-8"
              d="M272.27,84.08v-38.84h4.81l19.75,29.96h-2.38v-29.96h5.76v38.84h-4.81l-19.7-29.96h2.38v29.96h-5.8Z"
            />
            <path
              className="cls-8"
