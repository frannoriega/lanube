...
function formateWeekday(date: Date): string {
    return toCapitalCase(new Date(date).toLocaleDateString('es-AR', {
        weekday: 'long'
    }))
}
...
export { formatDateFull, formateWeekday, formatDate, formatTime, formatTimeShort, parseDateStringLocal }
